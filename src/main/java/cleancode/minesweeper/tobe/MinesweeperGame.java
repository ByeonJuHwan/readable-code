...
public class MinesweeperGame {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            int selectedRowIndex = concertRowFrom(cellInputRow);
    ...
    private static void checkIfGameIsOver() {
        boolean isAllOpened = isAllCllOpened();
        if (isAllOpened) {
            gameStatus = 1;
        }
    }

    private static boolean isAllCllOpened() {
    ...
    private static int concertRowFrom(char cellInputRow) {
